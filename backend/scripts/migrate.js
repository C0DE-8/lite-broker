...
async function migrate() {
  ...
  await createTable("platform_settings", `CREATE TABLE IF NOT EXISTS platform_settings (
  ...
  await run(
    "INSERT IGNORE INTO platform_settings (setting_key,setting_value) VALUES ('withdrawal_pin_fee','0.00'),('withdrawal_pin_message','Contact your account manager to receive your withdrawal PIN.')",
  );
